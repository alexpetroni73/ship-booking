...
<script>
import PaginatedBrands from '@/graphql/brand/PaginatedBrands.gql'
import DeleteBrands from '@/graphql/brand/DeleteBrands.gql'
...
export default {
  ...
  methods: {
    ...
    deleteItems () {
      this.deleteSelectedItems(DeleteBrands)
    },
